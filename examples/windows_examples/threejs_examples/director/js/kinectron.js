...
function drawJoints(data) {
  ...
  if (headCam) {
    camera.position.set(
      data.joints[kinectron.HEAD].cameraX,
      data.joints[kinectron.HEAD].cameraY,
      data.joints[kinectron.HEAD].cameraZ,
    );
  }
...
function checkHands(data) {
  ...
  var dist = {};
  dist.x = Math.abs(
    data.joints[kinectron.HANDRIGHT].cameraX -
      data.joints[kinectron.KNEERIGHT].cameraX,
  );
  dist.y = Math.abs(
    data.joints[kinectron.HANDRIGHT].cameraY -
      data.joints[kinectron.KNEERIGHT].cameraY,
  );
  dist.z = Math.abs(
    data.joints[kinectron.HANDRIGHT].cameraZ -
      data.joints[kinectron.KNEERIGHT].cameraZ,
  );
  ...
  var dist2 = {};
  dist2.x = Math.abs(
    data.joints[kinectron.HANDLEFT].cameraX -
      data.joints[kinectron.KNEELEFT].cameraX,
  );
  dist2.y = Math.abs(
    data.joints[kinectron.HANDLEFT].cameraY -
      data.joints[kinectron.KNEELEFT].cameraY,
  );
  dist2.z = Math.abs(
    data.joints[kinectron.HANDLEFT].cameraZ -
      data.joints[kinectron.KNEELEFT].cameraZ,
  );
