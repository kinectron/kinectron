...
})(
  {
    ...
    kdPp: [
      function (require, module, exports) {
        ...
        var binaryFeatures = require('./bufferbuilder')
          .binaryFeatures;
        ...
        Unpacker.prototype.unpack_float = function () {
          ...
          return (
            (sign === 0 ? 1 : -1) * fraction * Math.pow(2, exp - 23)
          );
        };
        ...
        Packer.prototype.pack_integer = function (num) {
          if (num >= -0x20 && num <= 0x7f) {
            ...
            // avoid invalid integer error on windows kinect skeleton
    ...
    s6SN: [
      function (require, module, exports) {
        ...
        function shimGetUserMedia(window) {
          ...
          var getUserMedia_ = function (
            constraints,
            onSuccess,
            onError,
          ) {
            shimConstraints_(constraints, function (c) {
              navigator.webkitGetUserMedia(c, onSuccess, function (
                e,
              ) {
                if (onError) {
      ...
      function (require, module, exports) {
            ...
            window.RTCPeerConnection.prototype.addStream = function addStream(
              ...
              stream.getTracks().forEach(function (track) {
                _this2._senders.push(
                  shimSenderWithDtmf(_this2, track),
                );
              });
            };
        ...
        function shimAddTrackRemoveTrackWithNative(window) {
          ...
          window.RTCPeerConnection.prototype.addTrack = function addTrack(
            ...
            if (!this._shimmedLocalStreams[stream.id]) {
              ...
              this._shimmedLocalStreams[stream.id].indexOf(sender) ===
              -1
            ) {
          ...
          window.RTCPeerConnection.prototype.addStream = function addStream(
            ...
            var newSenders = this.getSenders().filter(function (
              newSender,
            ) {
          ...
          window.RTCPeerConnection.prototype.removeTrack = function removeTrack(
            ...
            if (sender) {
              Object.keys(this._shimmedLocalStreams).forEach(
                function (streamId) {
                  var idx = _this10._shimmedLocalStreams[
                    streamId
                  ].indexOf(sender);

                  if (idx !== -1) {
                    _this10._shimmedLocalStreams[streamId].splice(
                      idx,
                      1,
                    );
                  }
                  ...
                  if (
                    _this10._shimmedLocalStreams[streamId].length ===
                    1
                  ) {
        ...
        function shimAddTrackRemoveTrack(window) {
          ...
          Object.defineProperty(
            ...
            {
              get: function () {
                var description = origLocalDescription.get.apply(
                  this,
                );
      ...
      function (require, module, exports) {
        ...
        SDPUtils.parseSctpDescription = function (mediaSection) {
          ...
          if (sctpMapLines.length > 0) {
            var parts = SDPUtils.matchPrefix(
              mediaSection,
              'a=sctpmap:',
            )[0]
              .substr(10)
        ...
        SDPUtils.writeSctpDescription = function (media, sctp) {
          ...
          if (sctp.maxMessageSize !== undefined) {
            output.push(
              'a=max-message-size:' + sctp.maxMessageSize + '\r\n',
            );
          }
          return output.join('');
        };
    ...
    NJ2u: [
      function (require, module, exports) {
        ...
        function getCommonCapabilities(
          ...
          var rtxCapabilityMatches = function (
            lRtx,
            rRtx,
            lCodecs,
            rCodecs,
        ...
        module.exports = function (window, edgeVersion) {
          ...
          RTCPeerConnection.prototype._createIceGatherer = function (
            ...
            this.transceivers[
              ...
              var end =
                !event.candidate ||
                Object.keys(event.candidate).length === 0; // polyfill since RTCIceGatherer.state is not implemented in
              // Edge 10547 yet.
          ...
          RTCPeerConnection.prototype.setLocalDescription = function (
            ...
            if (
              ['offer', 'answer'].indexOf(description.type) === -1
            ) {
              return Promise.reject(
                makeError(
                  'TypeError',
            ...
            if (description.type === 'offer') {
              ...
              sections.forEach(function (
                ...
                var remoteCapabilities =
                  transceiver.remoteCapabilities; // treat bundle-only as not-rejected.
          ...
          RTCPeerConnection.prototype.setRemoteDescription = function (
            ...
            sections.forEach(function (mediaSection, sdpMLineIndex) {
              ...
              if (description.type === 'offer' && !rejected) {
                  ...
                  transceiver.associatedRemoteMediaStreams.forEach(
                    function (s) {
                      var nativeTrack = s
                        ...
                        .find(function (t) {
                          return (
                            t.id === transceiver.rtpReceiver.track.id
                          );
                        });
                ...
                var hasRtx = commonCapabilities.codecs.filter(
                  function (c) {
      ...
      */
          ...
          RTCPeerConnection.prototype.createOffer = function () {
            ...
            pc.transceivers.forEach(function (
              ...
              var mid =
                transceiver.mid || SDPUtils.generateIdentifier();
              transceiver.mid = mid;
              ...
              if (
                ...
                transceiver.iceGatherer
                  ...
                  .forEach(function (cand) {
                    cand.component = 1;
                    sdp +=
                      'a=' + SDPUtils.writeCandidate(cand) + '\r\n';
                  });
          ...
          RTCPeerConnection.prototype.createAnswer = function () {
            ...
            pc.transceivers.forEach(function (
              ...
              var hasRtx = commonCapabilities.codecs.filter(function (
                c,
              ) {
                return c.name.toLowerCase() === 'rtx';
              }).length;
    ...
    XRic: [
      function (require, module, exports) {
        ...
        function shimPeerConnection(window) {
          ...
          _rtcpeerconnectionShim.default)(
            window,
          ...
          window.RTCPeerConnection = function RTCPeerConnection(
            ...
            if (config && config.iceServers) {
              config.iceServers = (0,
              _filtericeservers.filterIceServers)(
                config.iceServers,
                browserDetails.version,
              );
              utils.log(
              ...
              if (shouldPerformCheck) {
                ...
                initParameters.sendEncodings.forEach(function (
                  ...
                  if ('maxFramerate' in encodingParam) {
                    if (
                      !(parseFloat(encodingParam.maxFramerate) >= 0)
                    ) {
                      throw new RangeError(
      ...
      function (require, module, exports) {
        ...
        function shimGetUserMedia(window) {
          ...
          if (
            ...
            var _getUserMedia = mediaDevices.getUserMedia.bind(
              mediaDevices,
            );
        ...
        function shimRTCIceServerUrls(window) {
          ...
          window.RTCPeerConnection.prototype =
            OrigPeerConnection.prototype; // wrap static methods. Currently just generateCertificate.
      ...
      function (require, module, exports) {
        ...
        function shimRTCIceCandidate(window) {
          ...
          window.RTCIceCandidate.prototype =
            NativeRTCIceCandidate.prototype; // Hook up the augmented candidate in onicecandidate and
        ...
        function shimMaxMessageSize(window) {
          ...
          var sctpInDescription = function (description) {
            ...
            var sections = _sdp.default.splitSections(
              description.sdp,
            );
          ...
          var getMaxMessageSize = function (
            description,
            remoteIsFirefox,
          ) {
    ...
    KtlG: [
      function (require, module, exports) {
        ...
        var edgeShim = _interopRequireWildcard(
          require('./edge/edge_shim'),
        );
        ...
        var commonShim = _interopRequireWildcard(
          require('./common_shim'),
        );
    ...
    sXtV: [
      function (require, module, exports) {
        ...
        var webrtc_adapter_1 = __importDefault(
      ...
      function (require, module, exports) {
        ...
        ((function () {
          ...
          class_1.prototype.isBrowserSupported = function () {
            ...
            var validBrowser = this.supportedBrowsers.includes(
              browser,
            );
          ...
          class_1.prototype.getVersion = function () {
            return (
              adapter_1.webRTCAdapter.browserDetails.version || 0
            );
          };
    ...
    BHXf: [
      function (require, module, exports) {
        ...
        var BinaryPack = __importStar(
          require('peerjs-js-binarypack'),
        );
        ...
        ((function () {
          ...
          class_1.prototype.validateId = function (id) {
            // Allow empty ids
            return (
              !id || /^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(id)
            );
          };
          ...
          class_1.prototype.binaryStringToArrayBuffer = function (
            binary,
          ) {
          ...
          (function () {
            ...
            Logger.prototype.warn = function () {
              ...
              if (this._logLevel >= LogLevel.Warnings) {
                this._print.apply(
                  this,
                  __spread([LogLevel.Warnings], args),
                );
              }
            };
      ...
      function (require, module, exports) {
        ...
        var Negotiator =
          ...
          (function () {
            ...
            Negotiator.prototype.startConnection = function (
              options,
            ) {
            ...
            Negotiator.prototype._setupListeners = function (
              peerConnection,
            ) {
              var _this = this;
              ...
              peerConnection.ontrack = function (evt) {
                ...
                if (
                  connection.type === enums_1.ConnectionType.Media
                ) {
                  var mediaConnection = connection;

                  _this._addStreamToMediaConnection(
                    stream,
                    mediaConnection,
                  );
                }
        ...
        var MediaConnection =
          ...
          (function (_super) {
            ...
            function MediaConnection(peerId, provider, options) {
              var _this =
                _super.call(this, peerId, provider, options) || this;
            ...
            MediaConnection.prototype.addStream = function (
              remoteStream,
            ) {
            ...
            MediaConnection.prototype.handleMessage = function (
              message,
            ) {
            ...
            MediaConnection.prototype.answer = function (
              stream,
              options,
            ) {
              var e_1, _a;
              ...
              var messages = this.provider._getMessages(
                this.connectionId,
              );
        ...
        var DataConnection =
          ...
          (function (_super) {
            ...
            function DataConnection(peerId, provider, options) {
              ...
              _this.serialization =
                _this.options.serialization ||
                enums_1.SerializationType.Binary;
            ...
            DataConnection.prototype._handleDataMessage = function (
              _a,
            ) {
              var _this = this;
              ...
              var isBinarySerialization =
                this.serialization ===
                  enums_1.SerializationType.Binary ||
                this.serialization ===
                  enums_1.SerializationType.BinaryUTF8;
              ...
              if (isBinarySerialization) {
                if (datatype === Blob) {
                  ...
                  var ab = util_1.util.binaryStringToArrayBuffer(
                    data,
                  );
            ...
            DataConnection.prototype.handleMessage = function (
              message,
            ) {
              var payload = message.payload;
        ...
        var API =
          ...
          (function () {
            ...
            API.prototype._buildUrl = function (method) {
              var protocol = this._options.secure
                ? 'https://'
                : 'http://';
              var url =
                protocol +
          ...
          (function (_super) {
            ...
            function Peer(id, options) {
              ...
              if (_this._options.logFunction) {
                logger_1.default.setLogFunction(
                  _this._options.logFunction,
                );
              }
            ...
            Object.defineProperty(Peer.prototype, 'connections', {
              ...
              get: function get() {
                ...
                try {
                  for (
                    var _b = __values(this._connections),
                      _c = _b.next();
                    !_c.done;
                    _c = _b.next()
                  ) {
            ...
            Peer.prototype._initializeServerConnection = function () {
              ...
              this.socket.on(
                enums_1.SocketEventType.Message,
                function (data) {
                  _this._handleMessage(data);
                },
              );
              this.socket.on(enums_1.SocketEventType.Error, function (
                error,
              ) {
                _this._abort(
                  enums_1.PeerErrorType.SocketError,
                  error,
                );
              });
              this.socket.on(
                enums_1.SocketEventType.Disconnected,
                function () {
              ...
              switch (type) {
                ...
                case enums_1.ServerMessageType.Offer: {
                  ...
                  if (payload.type === enums_1.ConnectionType.Media) {
                    ...
                    payload.type === enums_1.ConnectionType.Data
                  ) {
                    ...
                    this.emit(
                      enums_1.PeerEventType.Connection,
                      connection,
                    );
                  } else {
                    logger_1.default.warn(
            ...
            Peer.prototype._storeMessage = function (
              connectionId,
              message,
            ) {
            ...
            Peer.prototype._cleanup = function () {
              ...
              try {
                for (
                  var _b = __values(this._connections.keys()),
                    _c = _b.next();
                  !_c.done;
                  _c = _b.next()
                ) {
            ...
            Peer.prototype.disconnect = function () {
              ...
              setTimeout(function () {
                if (!_this.disconnected) {
                  ...
                  _this.emit(
                    enums_1.PeerEventType.Disconnected,
                    _this.id,
                  );
