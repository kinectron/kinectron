(()=>{
    ...
    parcelRequire = function(e, r, t, n) {
                ...
                function i(e, t, n) {
                    if (e.RTCPeerConnection) {
                        ...
                        r.addEventListener = function(e, r) {
                            ...
                            return this._eventMap = this._eventMap || {}, this._eventMap[r] = i, o.apply(this, [
                                e,
                                i
                            ]);
                        };
                        ...
                        r.removeEventListener = function(e, n) {
                            ...
                            return delete this._eventMap[n], i.apply(this, [
                                e,
                                r
                            ]);
                ...
                function r(e) {
                    ...
                    if (null != e) {
                        for(var o in e)if (Object.prototype.hasOwnProperty.call(e, o)) {
                            var t = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(e, o) : {};
                            t.get || t.set ? Object.defineProperty(r, o, t) : r[o] = e[o];
                        }
                    }
                    ...
                    if (i.mediaDevices) {
                        var n = e.detectBrowser(r), a = function(e) {
                            ...
                            return Object.keys(e).forEach(function(t) {
                                if ("require" !== t && "advanced" !== t && "mediaSource" !== t) {
                                    ...
                                    if (void 0 !== i.ideal) {
                                        ...
                                        var a = {};
                                        "number" == typeof i.ideal ? (a[n("min", t)] = i.ideal, r.optional.push(a), (a = {})[n("max", t)] = i.ideal, r.optional.push(a)) : (a[n("", t)] = i.ideal, r.optional.push(a));
                                    }
                                    void 0 !== i.exact && "number" != typeof i.exact ? (r.mandatory = r.mandatory || {}, r.mandatory[n("", t)] = i.exact) : [
                                        "min",
                                        "max"
                                    ].forEach(function(e) {
                                        void 0 !== i[e] && (r.mandatory = r.mandatory || {}, r.mandatory[n(e, t)] = i[e]);
                                    });
                                }
                            ...
                            if ((e = JSON.parse(JSON.stringify(e))) && "object" === o(e.audio)) {
                                var d = function(e, r, o) {
                                    r in e && !(o in e) && (e[o] = e[r], delete e[r]);
                                };
                                d((e = JSON.parse(JSON.stringify(e))).audio, "autoGainControl", "googAutoGainControl"), d(e.audio, "noiseSuppression", "googNoiseSuppression"), e.audio = a(e.audio);
                            }
                            if (e && "object" === o(e.video)) {
                                ...
                                var s, u = n.version < 66;
                                if (c && ("user" === c.exact || "environment" === c.exact || "user" === c.ideal || "environment" === c.ideal) && (!i.mediaDevices.getSupportedConstraints || !i.mediaDevices.getSupportedConstraints().facingMode || u)) {
                                    if (delete e.video.facingMode, "environment" === c.exact || "environment" === c.ideal ? s = [
                                        "back",
                                        "rear"
                                    ] : "user" !== c.exact && "user" !== c.ideal || (s = [
                                        "front"
                                    ]), s) return i.mediaDevices.enumerateDevices().then(function(o) {
                                        var i = (o = o.filter(function(e) {
                                        ...
                                        return !i && o.length && s.includes("back") && (i = o[o.length - 1]), i && (e.video.deviceId = c.exact ? {
                                            exact: i.deviceId
                                        } : {
                                            ideal: i.deviceId
                                        }), e.video = a(e.video), t("chrome: " + JSON.stringify(e)), r(e);
                                    });
                                }
                                e.video = a(e.video);
                            }
                            return t("chrome: " + JSON.stringify(e)), r(e);
                        }, c = function(e) {
                        ...
                        if (i.getUserMedia = (function(e, r, o) {
                            d(e, function(e) {
                                i.webkitGetUserMedia(e, r, function(e) {
                                    o && o(c(e));
                                });
                            });
                        }).bind(i), i.mediaDevices.getUserMedia) {
                            var s = i.mediaDevices.getUserMedia.bind(i.mediaDevices);
        ...
        "uI5X": [
            function(require1, module1, exports) {
                ...
                function a(t) {
                    if ("object" !== o(t) || !t.RTCPeerConnection || "ontrack" in t.RTCPeerConnection.prototype) e.wrapPeerConnectionEvent(t, "track", function(e) {
                ...
                function c(e) {
                    if ("object" === o(e) && e.RTCPeerConnection && !("getSenders" in e.RTCPeerConnection.prototype) && "createDTMFSender" in e.RTCPeerConnection.prototype) {
                        var t = function(e, t) {
                            return {
                                track: t,
                                get dtmf () {
                        ...
                        e.RTCPeerConnection.prototype.removeStream = function(e) {
                            var t = this;
                            this._senders = this._senders || [], s.apply(this, [
                                e
                            ]), e.getTracks().forEach(function(e) {
                    ...
                    } else if ("object" === o(e) && e.RTCPeerConnection && "getSenders" in e.RTCPeerConnection.prototype && "createDTMFSender" in e.RTCPeerConnection.prototype && e.RTCRtpSender && !("dtmf" in e.RTCRtpSender.prototype)) {
                ...
                function d(t) {
                    if ("object" === o(t) && t.RTCPeerConnection && t.RTCRtpSender && t.RTCRtpReceiver) {
                ...
                function m(t) {
                    if (t.RTCPeerConnection) {
                        ...
                        if (t.RTCPeerConnection.prototype.addTrack && r.version >= 65) return h(t);
                        ...
                        var o = t.RTCPeerConnection.prototype.addStream;
        ...
        "6NZ1": [
            function(require1, module1, exports) {
                ...
                function e(r) {
                    ...
                    var e = {};
                    if (null != r) {
                        for(var t in r)if (Object.prototype.hasOwnProperty.call(r, t)) {
                            var u = Object.defineProperty && Object.getOwnPropertyDescriptor ? Object.getOwnPropertyDescriptor(r, t) : {};
                            u.get || u.set ? Object.defineProperty(e, t, u) : e[t] = r[t];
                        }
                    }
        ...
        "XRic": [
            function(require1, module1, exports) {
                ...
                Object.defineProperty(exports, "__esModule", {
                    value: !0
                }), exports.shimPeerConnection = c, exports.shimReplaceTrack = p, Object.defineProperty(exports, "shimGetUserMedia", {
                    enumerable: !0,
                    get: function() {
                ...
                function c(n) {
                    ...
                    var s = (0, t.default)(n, i.version);
                    n.RTCPeerConnection = function(t) {
                        return t && t.iceServers && (t.iceServers = (0, r.filterIceServers)(t.iceServers, i.version), e.log("ICE servers after filtering:", t.iceServers)), new s(t);
                    }, n.RTCPeerConnection.prototype = s.prototype;
                }
                function p(e) {
            ...
            {
                "../utils": "iSxC",
                "./filtericeservers": "6NZ1",
                "rtcpeerconnection-shim": "NJ2u",
                "./getusermedia": "YdKx",
                "./getdisplaymedia": "5P3b"
            }
        ],
        "/GzS": [
            function(require1, module1, exports) {
                ...
                function r(t) {
                    var r = e.detectBrowser(t), i = t && t.navigator, n = t && t.MediaStreamTrack;
                    if (i.getUserMedia = function(t, o, r) {
                        e.deprecated("navigator.getUserMedia", "navigator.mediaDevices.getUserMedia"), i.mediaDevices.getUserMedia(t).then(o, r);
                    }, !(r.version > 55 && "autoGainControl" in i.mediaDevices.getSupportedConstraints())) {
                        var s = function(e, t, o) {
                            t in e && !(o in e) && (e[o] = e[t], delete e[t]);
                        }, a = i.mediaDevices.getUserMedia.bind(i.mediaDevices);
                        if (i.mediaDevices.getUserMedia = function(e) {
                            return "object" === o(e) && "object" === o(e.audio) && (e = JSON.parse(JSON.stringify(e)), s(e.audio, "autoGainControl", "mozAutoGainControl"), s(e.audio, "noiseSuppression", "mozNoiseSuppression")), a(e);
                        }, n && n.prototype.getSettings) {
                            var p = n.prototype.getSettings;
                        ...
                        if (n && n.prototype.applyConstraints) {
                            var u = n.prototype.applyConstraints;
                            n.prototype.applyConstraints = function(e) {
                                return "audio" === this.kind && "object" === o(e) && (e = JSON.parse(JSON.stringify(e)), s(e, "autoGainControl", "mozAutoGainControl"), s(e, "noiseSuppression", "mozNoiseSuppression")), u.apply(this, [
                                    e
                                ]);
                            };
                        }
        ...
        "Fzdr": [
            function(require1, module1, exports) {
                ...
                Object.defineProperty(exports, "__esModule", {
                    value: !0
                }), exports.shimOnTrack = a, exports.shimPeerConnection = c, exports.shimSenderGetStats = s, exports.shimReceiverGetStats = p, exports.shimRemoveStream = u, exports.shimRTCDataChannel = C, exports.shimAddTransceiver = f, exports.shimCreateOffer = d, exports.shimCreateAnswer = y, Object.defineProperty(exports, "shimGetUserMedia", {
                    enumerable: !0,
                    get: function() {
                        return t.shimGetUserMedia;
                    }
                ...
                function a(e) {
                    "object" === i(e) && e.RTCTrackEvent && "receiver" in e.RTCTrackEvent.prototype && !("transceiver" in e.RTCTrackEvent.prototype) && Object.defineProperty(e.RTCTrackEvent.prototype, "transceiver", {
                        get: function() {
                            return {
                ...
                function c(t) {
                    var r = e.detectBrowser(t);
                    if ("object" === i(t) && (t.RTCPeerConnection || t.mozRTCPeerConnection)) {
                        if (!t.RTCPeerConnection && t.mozRTCPeerConnection && (t.RTCPeerConnection = t.mozRTCPeerConnection), r.version < 53 && [
                            "setLocalDescription",
                            "setRemoteDescription",
                            "addIceCandidate"
                        ].forEach(function(e) {
                ...
                function s(e) {
                    if ("object" === i(e) && e.RTCPeerConnection && e.RTCRtpSender && !(e.RTCRtpSender && "getStats" in e.RTCRtpSender.prototype)) {
                ...
                function p(t) {
                    if ("object" === i(t) && t.RTCPeerConnection && t.RTCRtpSender && !(t.RTCRtpSender && "getStats" in t.RTCRtpReceiver.prototype)) {
                ...
                function f(e) {
                    if ("object" === i(e) && e.RTCPeerConnection) {
        ...
        "t1lL": [
            function(require1, module1, exports) {
                ...
                function i(e) {
                    if ("object" === r(e) && e.RTCPeerConnection && ("getRemoteStreams" in e.RTCPeerConnection.prototype || (e.RTCPeerConnection.prototype.getRemoteStreams = function() {
                ...
                function n(e) {
                    if ("object" === r(e) && e.RTCPeerConnection) {
                        var t = e.RTCPeerConnection.prototype, o = t.createOffer, i = t.createAnswer, n = t.setLocalDescription, s = t.setRemoteDescription, a = t.addIceCandidate;
                        t.createOffer = function(e, t) {
                            var r = arguments.length >= 2 ? arguments[2] : arguments[0], i = o.apply(this, [
                                r
                            ]);
                            return t ? (i.then(e, t), Promise.resolve()) : i;
                        }, t.createAnswer = function(e, t) {
                            var r = arguments.length >= 2 ? arguments[2] : arguments[0], o = i.apply(this, [
                                r
                            ]);
                ...
                function c(t) {
                    ...
                    t.RTCPeerConnection = function(t, o) {
                        if (t && t.iceServers) {
                            for(var i = [], n = 0; n < t.iceServers.length; n++){
                                var s = t.iceServers[n];
                                !s.hasOwnProperty("urls") && s.hasOwnProperty("url") ? (e.deprecated("RTCIceServer.url", "RTCIceServer.urls"), (s = JSON.parse(JSON.stringify(s))).urls = s.url, delete s.url, i.push(s)) : i.push(t.iceServers[n]);
                            }
                            t.iceServers = i;
                        }
                        return new r(t, o);
                ...
                function i(n) {
                    if (n.RTCIceCandidate && !(n.RTCIceCandidate && "foundation" in n.RTCIceCandidate.prototype)) {
                        ...
                        n.RTCIceCandidate = function(t) {
                            if ("object" === r(t) && t.candidate && 0 === t.candidate.indexOf("a=") && ((t = JSON.parse(JSON.stringify(t))).candidate = t.candidate.substr(2)), t.candidate && t.candidate.length) {
                                var n = new o(t), i = e.default.parseCandidate(t.candidate), a = Object.assign(n, i);
                        ...
                        n.RTCPeerConnection.prototype.setRemoteDescription = function() {
                            ...
                            if (function(t) {
                                ...
                                var n, i = function(e) {
                                    ...
                                    return n != n ? -1 : n;
                                }(arguments[0]), a = (p = i, d = 65536, "firefox" === o.browser && (d = o.version < 57 ? -1 === p ? 16384 : 2147483637 : o.version < 60 ? 57 === o.version ? 65535 : 65536 : 2147483637), d), c = function(t, n) {
                                    var r = 65536;
                ...
                function m(e) {
                    ...
                    if (null != e) {
                        for(var r in e)if (Object.prototype.hasOwnProperty.call(e, r)) {
                            ...
                            s.get || s.set ? Object.defineProperty(i, r, s) : i[r] = e[r];
                        }
                    }
                    return i.default = e, i;
                }
                function h() {
                    var { window: m } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, h = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {
                        shimChrome: !0,
                        shimFirefox: !0,
                        shimEdge: !0,
                        shimSafari: !0
                    }, o = e.log, n = e.detectBrowser(m), d = {
                        browserDetails: n,
                        commonShim: t,
                    ...
                    switch(n.browser){
                        case "chrome":
                            if (!i || !i.shimPeerConnection || !h.shimChrome) return o("Chrome shim is not included in this adapter release."), d;
                            o("adapter.js shimming chrome."), d.browserShim = i, i.shimGetUserMedia(m), i.shimMediaStream(m), i.shimPeerConnection(m), i.shimOnTrack(m), i.shimAddTrackRemoveTrack(m), i.shimGetSendersWithDtmf(m), i.shimGetStats(m), i.shimSenderReceiverGetStats(m), i.fixNegotiationNeeded(m), t.shimRTCIceCandidate(m), t.shimConnectionState(m), t.shimMaxMessageSize(m), t.shimSendThrowTypeError(m), t.removeAllowExtmapMixed(m);
                            break;
                        case "firefox":
                            if (!s || !s.shimPeerConnection || !h.shimFirefox) return o("Firefox shim is not included in this adapter release."), d;
                            o("adapter.js shimming firefox."), d.browserShim = s, s.shimGetUserMedia(m), s.shimPeerConnection(m), s.shimOnTrack(m), s.shimRemoveStream(m), s.shimSenderGetStats(m), s.shimReceiverGetStats(m), s.shimRTCDataChannel(m), s.shimAddTransceiver(m), s.shimCreateOffer(m), s.shimCreateAnswer(m), t.shimRTCIceCandidate(m), t.shimConnectionState(m), t.shimMaxMessageSize(m), t.shimSendThrowTypeError(m);
                            break;
                        case "edge":
                            if (!r || !r.shimPeerConnection || !h.shimEdge) return o("MS edge shim is not included in this adapter release."), d;
                            o("adapter.js shimming edge."), d.browserShim = r, r.shimGetUserMedia(m), r.shimGetDisplayMedia(m), r.shimPeerConnection(m), r.shimReplaceTrack(m), t.shimMaxMessageSize(m), t.shimSendThrowTypeError(m);
                            break;
                        case "safari":
                            if (!a || !h.shimSafari) return o("Safari shim is not included in this adapter release."), d;
                            o("adapter.js shimming safari."), d.browserShim = a, a.shimRTCIceServerUrls(m), a.shimCreateOfferLegacy(m), a.shimCallbacksAPI(m), a.shimLocalStreamsAPI(m), a.shimRemoteStreamsAPI(m), a.shimTrackEventTransceiver(m), a.shimGetUserMedia(m), t.shimRTCIceCandidate(m), t.shimMaxMessageSize(m), t.shimSendThrowTypeError(m), t.removeAllowExtmapMixed(m);
                            break;
                        default:
            ...
            function(require1, module1, exports) {
                ...
                var n = function() {
                    ...
                    return Object.defineProperty(r.prototype, "logLevel", {
                        ...
                        r >= o.All ? console.log.apply(console, e(i)) : r >= o.Warnings ? console.warn.apply(console, e([
                            "WARNING"
                        ], i)) : r >= o.Errors && console.error.apply(console, e([
                            "ERROR"
                        ], i));
                    }, r;
                }();
            ...
            function(require1, module1, exports) {
                ...
                var e = this && this.__extends || function() {
                    ...
                    return function(t, r) {
                        ...
                        e(t, r), t.prototype = null === r ? Object.create(r) : (s.prototype = r.prototype, new s);
                    };
                }(), t = this && this.__read || function(e, t) {
                    var r = "function" == typeof Symbol && e[Symbol.iterator];
                    if (!r) return e;
                    var s, n, o = r.call(e), i = [];
                    try {
                        for(; (void 0 === t || t-- > 0) && !(s = o.next()).done;)i.push(s.value);
                    } catch (a) {
                        n = {
                            error: a
                        };
                    ...
                    for(var e = [], r = 0; r < arguments.length; r++)e = e.concat(t(arguments[r]));
                    return e;
                }, s = this && this.__values || function(e) {
                    var t = "function" == typeof Symbol && Symbol.iterator, r = t && e[t], s = 0;
                ...
                var o = require1("eventemitter3"), i = n(require1("./logger")), a = require1("./enums"), c = function(t) {
                    function n(e, r, s, n, o, i) {
                        ...
                        a.pingInterval = i, a._disconnected = !1, a._messagesQueue = [];
                        var c = e ? "wss://" : "ws://";
                        return a._wsUrl = c + r + ":" + s + n + "peerjs?key=" + o, a;
                    }
                    return e(n, t), n.prototype.start = function(e, t) {
                        this._id = e, this._wsUrl += "&id=" + e + "&token=" + t, this._startWebSocket();
                    }, n.prototype._startWebSocket = function() {
                        var e = this;
                        this._socket || (this._socket = new WebSocket(this._wsUrl), this._socket.onmessage = function(t) {
                            var r;
                            try {
                                r = JSON.parse(t.data), i.default.log("Server message received:", r);
                            } catch (s) {
                                return void i.default.log("Invalid server message", t.data);
                            }
                            e.emit(a.SocketEventType.Message, r);
                        }, this._socket.onclose = function(t) {
                            i.default.log("Socket closed.", t), e._disconnected = !0, clearTimeout(e._wsPingTimer), e.emit(a.SocketEventType.Disconnected);
                        }, this._socket.onopen = function() {
                            e._disconnected || (e._sendQueuedMessages(), i.default.log("Socket open"), e._scheduleHeartbeat());
                        });
                    }, n.prototype._scheduleHeartbeat = function() {
                        var e = this;
                        this._wsPingTimer = setTimeout(function() {
                            e._sendHeartbeat();
                        }, this.pingInterval);
                    }, n.prototype._sendHeartbeat = function() {
                        if (this._wsOpen()) {
                            var e = JSON.stringify({
                                type: a.ServerMessageType.Heartbeat
                            });
                            this._socket.send(e), this._scheduleHeartbeat();
                        } else i.default.log("Cannot send heartbeat, because socket closed");
                    }, n.prototype._wsOpen = function() {
                        return !!this._socket && 1 === this._socket.readyState;
                    }, n.prototype._sendQueuedMessages = function() {
                        var e, t, n = r(this._messagesQueue);
                        this._messagesQueue = [];
                        try {
                        ...
                        if (!this._disconnected) {
                            if (this._id) {
                                ...
                                } else this.emit(a.SocketEventType.Error, "Invalid message");
            ...
            function(require1, module1, exports) {
                ...
                var i = require1("./util"), o = n(require1("./logger")), r = require1("./negotiator"), a = require1("./enums"), s = require1("./baseconnection"), u = require1("./encodingQueue"), l = function(n) {
                    ...
                    return e(s, n), Object.defineProperty(s.prototype, "type", {
                        ...
                        } else this.serialization === a.SerializationType.JSON && (s = JSON.parse(o));
                        ...
                        if (this.open) {
                            if (this.serialization === a.SerializationType.JSON) this._bufferedSend(JSON.stringify(e));
            ...
            function(require1, module1, exports) {
                ...
                var i = require1("eventemitter3"), s = require1("./util"), a = r(require1("./logger")), c = require1("./socket"), l = require1("./mediaconnection"), d = require1("./dataconnection"), u = require1("./enums"), p = require1("./api"), h = function() {
                    ...
                    function i(e, n) {
                        ...
                        return c._destroyed = !1, c._disconnected = !1, c._open = !1, c._connections = new Map, c._lostMessages = new Map, e && e.constructor == Object ? n = e : e && (o = e.toString()), n = t({
                            debug: 0,
                        ...
                        }, n), c._options = n, "/" === c._options.host && (c._options.host = window.location.hostname), c._options.path && ("/" !== c._options.path[0] && (c._options.path = "/" + c._options.path), "/" !== c._options.path[c._options.path.length - 1] && (c._options.path += "/")), void 0 === c._options.secure && c._options.host !== s.util.CLOUD_HOST ? c._options.secure = s.util.isSecure() : c._options.host == s.util.CLOUD_HOST && (c._options.secure = !0), c._options.logFunction && a.default.setLogFunction(c._options.logFunction), a.default.logLevel = c._options.debug || 0, s.util.supports.audioVideo || s.util.supports.data ? o && !s.util.validateId(o) ? (c._delayedAbort(u.PeerErrorType.InvalidID, 'ID "' + o + '" is invalid'), c) : (c._api = new p.API(n), c._initializeServerConnection(), o ? c._initialize(o) : c._api.retrieveId().then(function(e) {
                    ...
                    return e(i, r), Object.defineProperty(i.prototype, "id", {
                        ...
                        var e = this;
                        this._socket = new c.Socket(this._options.secure, this._options.host, this._options.port, this._options.path, this._options.key, this._options.pingInterval), this.socket.on(u.SocketEventType.Message, function(t) {
                            e._handleMessage(t);
                        ...
                        a.default.error("Error:", t), "string" == typeof t && (t = new Error(t)), t.type = e, this.emit(u.PeerEventType.Error, t);
                        ...
                        var e = this;
                        setTimeout(function() {
                            e.disconnected || (e._disconnected = !0, e._open = !1, e.socket && e.socket.close(), e.emit(u.PeerEventType.Disconnected, e.id), e._lastServerId = e.id, e._id = null);
                        }, 0);
                    }, i.prototype.reconnect = function() {
                        if (this.disconnected && !this.destroyed) a.default.log("Attempting reconnection to server with ID " + this._lastServerId), this._disconnected = !1, this._initializeServerConnection(), this._initialize(this._lastServerId);
                        else {
    ...
    const $436ce2f67319af2a$var$Kinectron = function(arg1, arg2) {
        ...
        // Create new peer
        peer = new /*@__PURE__*/ ($parcel$interopDefault($8a778be88183940c$exports))(peerNet);
        ...
        this.getJoints = function(callback) {
            ...
            } else for(let jointType in this.body.joints){
...
//# sourceMappingURL=streamTest.17c52bc0.js.map
